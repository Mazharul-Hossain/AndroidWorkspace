...
public class MyAppMyState extends Application {
	...
	public JSONArray loadWebValue(JSONObject json, String provided_URI,
		...
		if (isNetworkConnected()) {
			try {
				...
				Log.d("log_tag", "Error in connection : " + e.toString());
			}
		}
		return jArray;
	}
	...
	public class Search_Index_Class {
		...
		public Search_Index_Class(JSONObject json1, String provided_URI1,
				String Check1, String user_mode1) {
			json = json1;
	...
	public void first_session(JSONObject json1, String provided_URI1,
			String Check1, String user_mode1) {

		Search_Index_Class search_Index_Class = new Search_Index_Class(json1,
				provided_URI1, Check1, user_mode1);
	...
	public int create_session(JSONObject json1, String provided_URI1,
			String Check1, String user_mode1, int search_index1) {
		Search_Index_Class search_Index_Class = new Search_Index_Class(json1,
				provided_URI1, Check1, user_mode1);

		search_index = search_index1;
		Iterator<Entry<Integer, Search_Index_Class>> it = myMap.entrySet()
				.iterator();

		while (it.hasNext()) {
			Entry<Integer, Search_Index_Class> entry = it.next();
			if (search_index < entry.getKey()) {
	...
	public void set_index(int search_index1, int offset) {
		...
		if (search_Index_Class != null) {
			...
			search_Index_Class.index -= offset;
