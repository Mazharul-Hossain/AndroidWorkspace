...
/**
 * An editable text view, extending {@link AutoCompleteTextView}, that can show
 * completion suggestions for the substring of the text where the user is typing
 * instead of necessarily for the entire thing.
 * <p>
 * You must must provide a {@link Tokenizer} to distinguish the various
 * substrings.
 * 
 * <p>
...
public class MultiAutoCompleteTextView extends AutoCompleteTextView {
	 ...
	 * length of that range meets or exceeds {@link #getThreshold}.
	 */
	@Override
	 ...
	 * {@link Tokenizer#findTokenStart} to {@link #getSelectionEnd} meets or
	 * exceeds {@link #getThreshold}.
	 */
	@Override
	 ...
	 * {@link Tokenizer#findTokenStart} to {@link #getSelectionEnd} by the the
	 * result of passing <code>text through
	...
	public static interface Tokenizer {
		 ...
		 * at offset <code>cursor within text.
		 */
	...
	/**
	 * This simple Tokenizer can be used for lists where the items are separated
