...
public class Add_Adv_Category extends Activity implements
	...
	private void SpinnerInflater() {
		if (typeBar == Top_Category) {
			...
			category_autoCompleteTextView.setAdapter(adapter_Category);
	...
	/************** Next Page Method ***************/
	private void next_page(int prod_id) {
