 ...
 */
public class TitleEditor extends Activity implements
	...
	protected void onResume() {
		...
		mProgressBar = ProgressDialog
				.show(this, null, "Loading title...", true);
	}
	...
	public void onClickOk(View v) {
		...
		if (mCursor != null) {
			...
			// edit
			// box.
			values.put(NotePad.Notes.COLUMN_NAME_TITLE, mText.getText()
					.toString());
			 ...
			 * 
			 * Note: This is being done on the UI thread. It will block the
			 * thread until the update completes. In a sample app, going against
			 * a simple provider based on a local database, the block will be
	...
	public Loader<Cursor> onCreateLoader(int arg0, Bundle arg1) {
		 ...
		 */
		return new CursorLoader(this, mUri, PROJECTION, // The columns to
														// retrieve
	...
	public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
		...
		if (mCursor != null) {
			...
			// *before* the first record retrieved. This moves it to the first
			// record.
			mCursor.moveToFirst();
