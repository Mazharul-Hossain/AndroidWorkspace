...
public class AstroboyMasterConsole extends RoboSherlockActivity {
	...
	// Guice will find or create the appropriate instance of
	// AstroboyRemoteControl for us
	// Since we haven't specified a special binding for AstroboyRemoteControl,
	// Guice
	// will create a new instance for us using AstroboyRemoteControl's default
	// constructor.
