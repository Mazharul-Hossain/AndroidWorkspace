...
public class InstaLoginDialog extends Dialog {
	...
	private final AuthDialogListener mAuthDialogListener;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addContentView(linearLayout, new FrameLayout.LayoutParams((int) (dimensions[0]
				* scale + 0.5f), (int) (dimensions[1] * scale + 0.5f)));
