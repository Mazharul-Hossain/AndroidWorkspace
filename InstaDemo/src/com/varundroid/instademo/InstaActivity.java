...
public class InstaActivity extends Activity implements OnClickListener {
	...
	public class AuthListener implements
			com.varundroid.instademo.InstaImpl.AuthAuthenticationListener {
		@Override
		public void onSuccess() {
			Toast.makeText(InstaActivity.this, "Instagram Authorization Successful",
					Toast.LENGTH_SHORT).show();
		}

		@Override
		public void onFail(String error) {
			Toast.makeText(InstaActivity.this, "Authorization Failed", Toast.LENGTH_SHORT)
					.show();
		}
	}
