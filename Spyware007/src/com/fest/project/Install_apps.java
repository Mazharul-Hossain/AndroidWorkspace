...
public class Install_apps<Ins> extends Activity implements OnItemClickListener {
   ...
   public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.listinstalledapps);
   ...
   public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
      ...
      else
      {
    	...
    	//  Toast.makeText(this, "permission list is null", Toast.LENGTH_LONG).show();
      }
   ...
   private void SHOW_DIALOG(App app,String reqPermission) 
   {
	// TODO Auto-generated method stub
	   myDialog = new Dialog(Install_apps.this);
...
private List<App> loadInstalledApps(boolean includeSysApps) throws NameNotFoundException 
   {
