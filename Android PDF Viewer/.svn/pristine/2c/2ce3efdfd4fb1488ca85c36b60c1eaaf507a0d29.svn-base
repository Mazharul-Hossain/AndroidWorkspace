...
public class AwtPdfRenderer {
	...
	final static int maxX = 200;
	final static int maxY = 200;

//	private final static String PDFFILENAME = "U:/Android/workspace/AwtPdfRenderer/examples/grayimage_example.pdf";
//	private final static String PDFFILENAME = "U:/Android/workspace/AwtPdfRenderer/examples/ip-zit.pdf";
//	private final static String PDFFILENAME = "U:/Android/PDFs/DINI_Informationsinfrastrukturen.pdf";
	private final static String PDFFILENAME = "U:/Android/PDFs/Synopse_der_Antworten_auf_Wahlpruefsteine.pdf";
//	private final static String PDFFILENAME = "U:/Android/PDFs/gesamt.pdf";
//	private final static String PDFFILENAME = "U:/Android/PDFs/examples/neu/User_Manual_T-Mobile_G1_D.pdf";
//	private final static String PDFFILENAME = "U:/Android/PDFs/examples/neu/Bedienungsanleitung_T-Mobile_G1_A.pdf";
	...
	public void openFile(File file) throws IOException, InterruptedException {
		...
		log("\n" + pdfPage.getPageNumber() + ":" + pdfPage.getWidth() + "x"
				+ pdfPage.getHeight());
//		Rectangle2D useClip = new Rectangle2D.Float(0+70, 0+500, 595-400, 842-500-70);
		float zoom = 1.00f;
