...
public class Stream extends Dictionary {
    ...
    // TODO [FHe] ccitt fax decode
//    private byte[] decodeCCITTFaxDecodeOrDCTDecodeImage(
//            int width, int height, PColorSpace colourSpace, int bitspercomponent, int fill,
//            Bitmap smaskImage, Bitmap maskImage, int[] maskMinRGB, int[] maskMaxRGB) {
//        byte[] data = null;
//
...
//    }
    ...
    private void dctDecode(
        ...
        if (tmpImage == null) {
            try {
            	// TODO [FHe]: decode jpegs
//            	if (true) throw new Exception("JPEG decoding not yet supported"); 
//            	
...
//CCITTFax.showRenderedImage(img, title);
    ...
    private Bitmap getImage(
            PColorSpace colourSpace, int fill,
...
//                Bitmap img = makeImageWithRasterFromBytes(
//                        colourSpace, fill,
//                        width, height,
//                        colorSpaceCompCount,
//                        bitspercomponent,
