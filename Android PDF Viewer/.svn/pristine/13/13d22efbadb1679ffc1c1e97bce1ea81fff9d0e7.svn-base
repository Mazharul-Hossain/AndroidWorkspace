/*
 * $Id: PDFParser.java,v 1.13 2009/08/06 00:49:22 tomoke Exp $
 *
...
public class PDFParser extends BaseWatchable {
    ...
    // [FHe] turn on debugging ("4000" -> "-1")
//    public static int debuglevel = 4000;
    public static int debuglevel = -1; // turn on debugging
