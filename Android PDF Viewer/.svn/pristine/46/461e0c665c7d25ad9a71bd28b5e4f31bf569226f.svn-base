 ...
 * @since 2.0
 */
public class PRectangle extends Rectangle2Df {
     ...
     */
    public PRectangle(PointF p1, PointF p2) {
        super();
     ...
     */
    public Rectangle2Df getOriginalPoints() {
        return new Rectangle2Df(p1x, p1y, p2x, p2y);
    }
     ...
     */
    public Rectangle2Df toJava2dCoordinates() {
        return new Rectangle2Df(x, y - height, width, height);
    }
