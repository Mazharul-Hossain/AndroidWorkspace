...
public class Font extends org.icepdf.core.pobjects.fonts.Font {
    ...
    // Base 14 AFM fonts
    protected AFM afm;
    // Android font style reference, ITALIC or BOLD|ITALIC
    protected int style = Typeface.NORMAL;
    // Array of type1 font differences based on family names.
    static final String type1Diff[][] = {{"Bookman-Demi", "URWBookmanL-DemiBold", "Arial"}, {
...
//        isAFMFont = true;
        ...
        // TODO: do we need to implement this part?
