...
public class ImageCache {
    ...
    static {
        ...
        if (Defs.sysPropertyBoolean("org.icepdf.core.imagecache.use14", true)) {
            ...
            try {
            	// TODO [FHe]: imaging subsystem 
            	if (true) throw new Exception("imaging subsystem not yet supported");
...
//
     ...
     */
    public void setImage(Bitmap image, boolean useCaching) {
        try {
            ...
            if (useCaching) {//isCachingEnabled) {
                ...
                // Java 1.3 loading methods
                	...
                	// TODO [FHe]: jpeg support 
                	if (true) throw new IOException("JPEG encoder not yet supported");
        ...
        if (isCached) {//isCachingEnabled) {
            ...
            try {
                ...
                if (imageIOReadMethod != null) {
                    ...
                    readArgs[0] = tempFile;
                    try {
                        image = (Bitmap) imageIOReadMethod.invoke(null, readArgs);
                    }
                    catch (Throwable t) {
                        logger.log(Level.FINE,
                ...
                // Java 1.3
                	...
                	// TODO [FHe]: jpeg decoder 
                	if (true) throw new IOException("jpeg decoder not yet supported");
//                    try {
...
//                    }
    ...
    public static Bitmap scaleBufferedImage(Bitmap bim, int width, int height) {
        ...
        */
        ...
        if (imageScale != 1.0) {
            ...
            tx.preScale(imageScale, imageScale);
            Bitmap sbim = Bitmap.createBitmap(width, height, Config.ARGB_8888);
            Canvas can = new Canvas(sbim);
            can.drawBitmap(bim, tx, null);
            bim.recycle();
            bim = null;
            bim = sbim;
        }
