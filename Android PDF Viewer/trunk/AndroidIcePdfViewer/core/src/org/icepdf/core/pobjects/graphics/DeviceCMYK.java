...
public class DeviceCMYK extends PColorSpace {
     ...
     * @return valid rgb colour object.
     */
    private static int alternative1(float[] f) {
     ...
     * @return valid rgb colour object.
     */
    private static int alternative3(float[] f) {
     ...
     * @return valid rgb colour object.
     */
    private static int getAutoCadColor(float[] f) {
        ...
        return Color.rgb((int)(red*0xff), (int)(green*0xff), (int)(blue*0xff));
    }
     ...
     * @return valid rgb colour object.
     */
    private static int getGhostColor(float[] f) {
     ...
     * @return valid rgb colour object.
     */
    private static int getAdobeColor(float[] f) {
     ...
     * @return valid rgb colour object.
     */
    private static int alternative2(float[] f) {
        float inCyan = f[3];
        float inMagenta = f[2];
        float inYellow = f[1];
        float inBlack = f[0];
        ...
        return Color.rgb((int)(outRed*0xff), (int)(outGreen*0xff), (int)(outBlue*0xff));
    }
