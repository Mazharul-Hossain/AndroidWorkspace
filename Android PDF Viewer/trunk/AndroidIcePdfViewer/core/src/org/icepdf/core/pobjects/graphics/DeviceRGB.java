...
public class DeviceRGB extends PColorSpace {
     ...
     */
    public int getColor(float[] colours) {

        return Color.rgb((int)(validateColorRange(colours[2])*0xff),
        		(int)(validateColorRange(colours[1])*0xff),
        		(int)(validateColorRange(colours[0])*0xff));
    }
}
