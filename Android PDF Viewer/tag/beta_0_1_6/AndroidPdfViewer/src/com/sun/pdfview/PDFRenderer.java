...
//Log.i(TAG, "executing command "+cmd.toString() + ": " + cmd.getDetails());
if (cmd instanceof PDFShapeCmd) {
	PDFShapeCmd shapeCmd = (PDFShapeCmd) cmd;
	Log.i(TAG, "executing command "+cmd.toString() + ": " + cmd.getDetails());
	String details = shapeCmd.getDetails();
}
