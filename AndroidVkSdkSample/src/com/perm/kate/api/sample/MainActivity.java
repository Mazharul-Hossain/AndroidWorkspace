...
public class MainActivity extends Activity {
	...
	private final OnClickListener authorizeClick = new OnClickListener() {
		@Override
	...
	private final OnClickListener logoutClick = new OnClickListener() {
		@Override
		public void onClick(View v) {
			logOut();
		}
	...
	private final OnClickListener postClick = new OnClickListener() {
		@Override
		public void onClick(View v) {
			postToWall();
		}
	...
	private void postToWall() {
		// Communication with the server in a separate thread so as not to block
		// the UI flow
		new Thread() {
			@Override
			public void run() {
				try {
					...
					api.createWallPost(account.user_id, text, null, null, false, false,
							false, null, null, null, null, null, null);
					// Show a message to the UI thread
